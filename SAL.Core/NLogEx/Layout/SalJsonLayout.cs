    ...
    public class SalJsonLayout : NLog.Layouts.Layout
    {
        ...
        protected override string GetFormattedMessage(LogEventInfo logEvent)
        {
            ...
            var salLogEvent = new SalLogEventInfo
            {
                ...
                AdapterType = ServiceConfiguration.AdapterType,
                AdapterName = ServiceConfiguration.AdapterName,
                AdapterVersion = ServiceConfiguration.AdapterVersion,
                SalVersion = ServiceConfiguration.SalVersion,
                Contour = ServiceConfiguration.Contour,
                AdapterHostIp = ServiceConfiguration.AdapterHostIp,
                AdapterHostName = ServiceConfiguration.AdapterHostName,
