...
namespace SAL.Core.Rabbit.Interfaces
{
    ...
    {
        ISubscription CreateEvent(ushort prefetchCount, IEnumerable<EventInfo> eventInfos, Func<RabbitMessage, Action, Action, Task> handler, string subscriptionName ="Event");
